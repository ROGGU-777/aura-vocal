...
const CORPORATE_FORM = "https://form.jotform.com/261566567433061";
const PREMIUM_FORM   = "https://form.jotform.com/261567091573059";
const EXCLUSIVE_FORM = "https://form.jotform.com/261567136681059";
...
const DEMOS = [
  ...
  {id:6,size:"compact",title:"BECOMING",subtitle:"Identity · Transformation · Universal Arrival",tag:"AUTOMOTIVE",tone:"Inevitable · Intimate",accentSolid:"#fb923c",src:"/demos/Track6.mp3",description:"Aesthetic Blueprint: Brand-Agnostic Aspiration, Emotional Universality, The Moment Before Everything Changes. Recorded this way because the most powerful automotive campaigns never sell the vehicle — they sell the version of yourself you become when you enter it. This performance was deliberately unbranded so that every prospect who hears it thinks: this was made for whoever I am trying to become. Studio Engineering: Dry intimate capture, breath retention at precision intervals, zero spatial processing — the voice alone carries the full emotional load. Deployment Target: Prestige Automotive Launches, Global Brand Identity Campaigns, Multi-Vertical Prospect Conversion."},
  {id:7,size:"featured",title:"OPULENT",subtitle:"Luxury Fashion · Prestige · The Moment Opportunity Wears the Right Thing",tag:"SIGNATURE",tone:"Commanding · Magnetic",accentSolid:"#22d3ee",src:"/demos/Track7.mp3",description:"Aesthetic Blueprint: Confident Arrival, Magnetic Restraint, Desire Without Explanation. Recorded this way because the luxury fashion audience does not want to be sold to — they want to feel that the product already belongs to the life they are living or the life they are stepping into. Every pause in this performance was a production decision. Every breath carries intention. Studio Engineering: Silken high-frequency capture, intimate close-mic proximity, custom luxury spatial signature by Aura Vocal Studios. Deployment Target: Global Luxury Fashion Campaigns, Premium Fragrance Launches, High-Net-Worth Lifestyle Brand Activations."},
...
const CASE_STUDIES = [
  ...
  {
    id:"cs2",
    tag:"SPEC · LUXURY FASHION",
    category:"Prestige Fashion & Fragrance",
    title:"OPULENT — The Arrival Brief",
    brief:"A prestige fashion house (spec) required a voice that could carry a luxury campaign without selling a single thing. The brief was one moment: the arrival — when opportunity and elegance occupy the same space simultaneously.",
    direction:"Commanding without force. Magnetic without effort. The read had to feel like the product was already chosen — the voice simply confirming what the audience already knew about themselves. Silence between lines: not a gap. A statement.",
    execution:"Three passes across two tonal registers: one bare and architectural, one layered with controlled authority, one that treated each line as its own complete world. The selected take runs 60 seconds — four seconds of pure silence inside it, deliberate and exact.",
    outcome:"The performance redefines the luxury fashion demo category — proof that a voice can carry the full weight of desire and confidence without a single explanatory word. The standard now briefed against for all prestige fashion and lifestyle commissions.",
    accent:"#22d3ee",
    accentDim:"#22d3ee22",
    stat:"4s",
    statLabel:"Of silence — deliberate, inside the take",
    mailto:PREMIUM_MAILTO,
  },
  {
    id:"cs3",
    tag:"SPEC · BRAND IDENTITY",
    category:"Universal Brand Campaign",
    title:"BECOMING — The Prospect Brief",
    brief:"No brand name. No product category. No target demographic specified. The brief was to create a performance so identity-agnostic and emotionally precise that any prospect hearing it would think: this was made for whoever I am trying to become.",
    direction:"The read had to live in the space between aspiration and arrival — not what the audience wants to buy, but who they want to be. Tone: inevitable. Pace: the moment before a decision is made. Every word weighted as if it cost something.",
    execution:"Two-minute performance across three emotional movements: recognition, tension, and release. Built to work across automotive, fashion, real estate, financial services, and luxury lifestyle simultaneously — the voice as a universal brief.",
    outcome:"The most versatile performance in the Aura Vocal Studios catalogue. Played to prospects across five verticals — all five asked what brand it was made for. The correct answer: yours.",
    accent:"#fb923c",
    accentDim:"#fb923c22",
    stat:"5",
    ...
    <div style={{background:bg,color:tp,minHeight:"100vh",fontFamily:"'Cormorant Garamond',Georgia,serif",overflowX:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:1}}>
        ...
        <section id="work" style={{padding:"100px 28px 120px",maxWidth:"1280px",margin:"0 auto"}}>
          ...
          <CatLabel label="III — OPULENT, Gaming & Prestige" isDark={isDark}/>
          <div style={{display:"grid",gridTemplateColumns:"repeat(12,1fr)",gap:"16px",marginBottom:"40px"}}>
