...
const BOOKING_LINK = "mailto:concierge@studiohqauravocal.site?subject=Commission%20a%20Session%20%E2%80%94%20Aura%20Vocal%20Studios&body=Dear%20David%2C%0A%0AI%20would%20like%20to%20commission%20a%20voice%20session%20with%20Aura%20Vocal%20Studios.%0A%0A1.%20Organisation%20%26%20Role%3A%20%5BCompany%20name%20and%20your%20position%5D%0A%0A2.%20Project%20Title%3A%20%5BWorking%20title%20or%20campaign%20codename%5D%0A%0A3.%20Session%20Type%3A%20%5BCommercial%20%2F%20Documentary%20%2F%20Gaming%20%2F%20Corporate%20Narration%20%2F%20Trailer%20%2F%20Other%5D%0A%0A4.%20Script%20Status%3A%20%5BFinal%20%2F%20In%20revision%20%2F%20Brief%20stage%5D%0A%0A5.%20Intended%20Distribution%3A%20%5BNetwork%20broadcast%20%2F%20Digital%20%2F%20Cinema%20%2F%20Global%20%2F%20Regional%5D%0A%0A6.%20Creative%20Direction%3A%20%5BTone%2C%20pacing%2C%20emotional%20register%2C%20campaign%20references%5D%0A%0A7.%20Session%20Deadline%3A%20%5BRequired%20delivery%20date%5D%0A%0A8.%20Production%20Budget%3A%20%5BApproximate%20range%5D%0A%0AKind%20regards%2C%0A%5BYour%20Name%5D%0A%5BOrganisation%5D";
...
const buildSimilarMailto = (title) => {
  const subject = encodeURIComponent(`Commission a Similar Session — ${title} — Aura Vocal Studios`);
  const body = encodeURIComponent(
`Dear David,

I came across the "${title}" work on your portfolio and would like to commission something in a similar direction.
...
Creative Direction (tone, pacing, emotional register): 
...
[Organisation]`
  ...
  return `mailto:concierge@studiohqauravocal.site?subject=${subject}&body=${body}`;
};
                ...
                onMouseLeave={e=>{e.currentTarget.style.borderColor=isDark?"rgba(255,255,255,0.055)":"rgba(0,0,0,0.08)";e.currentTarget.style.boxShadow=isDark?"0 8px 40px rgba(0,0,0,0.45)":"0 6px 28px rgba(0,0,0,0.07)";}}>
                  ...
                  <div style={{display:"grid",gridTemplateColumns:"1fr 280px",gap:"0"}}>
                    ...
                    <div style={{padding:"44px 36px",display:"flex",flexDirection:"column",justifyContent:"space-between",background:isDark?`linear-gradient(135deg,${cs.accentDim},transparent)`:`linear-gradient(135deg,${cs.accentDim},transparent)`}}>
                      ...
                      <a href={buildSimilarMailto(cs.title)} className="sans" style={{
