...
const DEMOS = [
  ...
  {id:11,size:"compact",title:"Meridian",subtitle:"Authority · Restraint · The Apex of Any Category",tag:"PRESTIGE",tone:"Sovereign · Inevitable",accentSolid:"#4ade80",src:"/demos/Track11.mp3",description:"Aesthetic Blueprint: Absolute Arrival, Authority Without Explanation, The Register of Brands That Have Already Won. Recorded this way because the most commanding campaigns across every major vertical — automotive, financial services, luxury fashion, elite sport — share one creative truth: the voice cannot be reaching for anything. It must already be there. This performance is that register. Studio Engineering: Precision broadcast capture, controlled breath architecture, minimal processing — the discipline in the engineering mirrors the discipline of the brands this serves. Deployment Target: Ultra-Prestige Brand Identity Campaigns, Global Financial Services, Premium Automotive, Elite Sports Sponsorship, Luxury Fashion and Heritage Brand Activations."},
...
const FAQS = [
  {
    ...
    a:"Sub-48 hours from session completion is the standing commitment — for most projects, a broadcast-ready first-pass file is in your hands within 24 hours. Rush turnaround is available on request. Your deadline is not a negotiation: it is a commitment that gets met, without exception.",
  },
  {
    q:"Do you offer remote directed sessions?",
    a:"Yes. Remote directed sessions are available globally via Source-Connect and live Zoom. Your creative director can issue real-time direction regardless of timezone or geography. Session scheduling is confirmed once the brief and contract are in place.",
  },
  {
    q:"What file formats are delivered, and are they distribution-ready?",
    a:"All deliverables are delivered as broadcast-quality 48kHz WAV and high-bitrate MP3, formatted to your technical specification. Stems, dry takes, and alternate mix configurations are available on request. Every file is rights-cleared for worldwide territory distribution from the moment of receipt.",
  },
  {
    q:"How does the revision process work?",
    a:"All engagements include a minimum of one full revision round within the agreed scope. Premium and Exclusive tier projects include unlimited revisions within scope. In practice, the majority of clients sign off on the first-pass final — revision rounds are rarely required.",
  },
  {
    q:"Do you sign NDAs?",
    a:"Yes, without hesitation. Non-disclosure agreements are executed as standard practice on any engagement where confidentiality is required. NDAs are accommodated pre-brief, and no project detail leaves the studio without written consent.",
  },
  {
    q:"What is the commissioning process from brief to delivery?",
    a:"The process begins the moment you submit a brief. David reviews it personally, confirms scope and investment, and returns a signed agreement within the business day. The session is then scheduled, delivered, and signed off — typically in a single pass. No casting overhead, no coordinator friction, no creative attrition between brief and file.",
  },
  {
    q:"Can you work from scripts at draft or brief stage?",
    a:"Yes. Aura Vocal Studios works from final scripts, working drafts, and detailed briefs. Where copy is still in development, David provides creative direction notes as part of the engagement. The studio does not require finished copy to confirm scope or schedule a session.",
  },
  {
    q:"What defines each pricing tier?",
    a:"The Corporate tier covers single-deliverable campaigns — product spots, brand commercials, digital advertising — scoped to script length, usage rights, and distribution. The Premium tier is for multi-deliverable campaign packages, IVR suites, gaming, or cinematic projects requiring session depth. The Exclusive tier covers full campaign suites, global brand launches, and AAA productions where the standard is absolute. All tiers are scoped to the exact requirements of the project.",
  },
];
...
const FAQSection = ({isDark}) => {
  ...
  return (
    <section style={{padding:"100px 28px",maxWidth:"1280px",margin:"0 auto",borderTop:`1px solid ${isDark?"rgba(255,255,255,0.055)":"rgba(0,0,0,0.09)"}`}}>
      <div className="faq-grid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"80px",alignItems:"start"}}>
        ...
        <div className="faq-sticky" style={{position:"sticky",top:"100px"}}>
          <div className="sans" style={{display:"inline-flex",alignItems:"center",gap:"8px",marginBottom:"16px"}}>
            ...
            <span style={{fontSize:"9px",letterSpacing:"0.32em",color:"#C9A961",fontWeight:700}}>COMMON QUESTIONS</span>
          </div>
          <h2 className="serif" style={{fontSize:"clamp(28px,3.8vw,52px)",fontWeight:700,color:tp,lineHeight:1.09,letterSpacing:"-0.025em",marginBottom:"22px"}}>
            Everything You<br/>
            <span style={{fontStyle:"italic",fontWeight:300,color:tm}}>Need to Know</span>
          </h2>
          <p className="sans" style={{fontSize:"13.5px",lineHeight:1.82,color:tm,fontWeight:300,marginBottom:"36px"}}>
            If your question isn't answered below, send the brief directly — David responds to all enquiries personally within the business day.
          </p>
          <a href={FAQ_ENQUIRY_GMAIL} target="_blank" rel="noopener noreferrer" className="sans" style={{display:"inline-flex",alignItems:"center",gap:"8px",padding:"12px 26px",borderRadius:"100px",border:`1px solid ${border}`,background:"transparent",color:tm,fontSize:"12px",letterSpacing:"0.06em",fontWeight:500,textDecoration:"none",transition:"all 0.3s ease"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#C9A96150";e.currentTarget.style.color=tp;}} onMouseLeave={e=>{e.currentTarget.style.borderColor=border;e.currentTarget.style.color=tm;}}><MailIcon/> Send a Direct Question</a>
        </div>
        {/* Right — accordion */}
        <div style={{display:"flex",flexDirection:"column",gap:"2px"}}>
          {FAQS.map((item,i)=>{
            const isOpen=open===i;
            return (
              <div key={i} style={{borderRadius:"16px",overflow:"hidden",border:`1px solid ${isOpen?"rgba(201,169,97,0.22)":border}`,background:isOpen?(isDark?"rgba(201,169,97,0.04)":"rgba(255,255,255,0.92)"):(isDark?"rgba(255,255,255,0.018)":"rgba(255,255,255,0.72)"),transition:"border-color 0.3s ease,background 0.3s ease",marginBottom:"8px"}}>
                <button onClick={()=>setOpen(isOpen?null:i)} style={{width:"100%",display:"flex",alignItems:"center",justifyContent:"space-between",padding:"22px 26px",background:"transparent",border:"none",cursor:"pointer",gap:"16px",textAlign:"left"}}>
                  <span className="sans" style={{fontSize:"13.5px",fontWeight:600,color:isOpen?"#C9A961":tp,letterSpacing:"0.01em",lineHeight:1.4,transition:"color 0.3s ease"}}>{item.q}</span>
                  <span style={{flexShrink:0,width:"22px",height:"22px",borderRadius:"50%",border:`1px solid ${isOpen?"rgba(201,169,97,0.4)":border}`,display:"flex",alignItems:"center",justifyContent:"center",color:isOpen?"#C9A961":ts,fontSize:"14px",lineHeight:1,transition:"all 0.3s ease",transform:isOpen?"rotate(45deg)":"rotate(0deg)"}}>{isOpen?"✕":"+"}</span>
                </button>
                {isOpen&&(
                  <div style={{padding:"0 26px 24px"}}>
                    <div style={{height:"1px",background:isDark?"rgba(201,169,97,0.12)":"rgba(0,0,0,0.06)",marginBottom:"20px"}}/>
                    <p className="sans" style={{fontSize:"13px",lineHeight:1.82,color:isDark?tm:"#374151",fontWeight:300,margin:0}}>{item.a}</p>
                  </div>
                )}
              </div>
            );
  ...
  return (
    <div style={{background:bg,color:tp,minHeight:"100vh",fontFamily:"'Cormorant Garamond',Georgia,serif",overflowX:"hidden"}}>
      ...
      <div style={{position:"relative",zIndex:1}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr auto",gap:"72px",alignItems:"center"}}>
            <div>
              ...
              <div className="fu fu4" style={{display:"flex",alignItems:"center",gap:"14px",flexWrap:"wrap"}}>
                ...
                <a href={DIRECT_LINE_GMAIL} target="_blank" rel="noopener noreferrer" className="sans" style={{display:"inline-flex",alignItems:"center",gap:"8px",padding:"14px 30px",borderRadius:"100px",border:`1px solid ${border}`,background:isDark?"rgba(255,255,255,0.03)":"rgba(0,0,0,0.04)",color:tm,fontSize:"13px",letterSpacing:"0.05em",textDecoration:"none",transition:"all 0.3s ease"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#C9A96150";e.currentTarget.style.color=tp;}} onMouseLeave={e=>{e.currentTarget.style.borderColor=border;e.currentTarget.style.color=tm;}}><MailIcon/> Direct Line</a>
              </div>
        ...
        <section id="process" style={{padding:"100px 28px",maxWidth:"1280px",margin:"0 auto"}}>
        ...
        {/* PRICING */}
        <section id="pricing" style={{padding:"100px 28px 112px",maxWidth:"1280px",margin:"0 auto"}}>
          {/* Section header */}
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:"40px",marginBottom:"48px"}}>
            ...
            <div style={{display:"flex",gap:"60px"}}>
              <div>
                ...
                {[{l:"Portfolio",h:"#work"},{l:"Process",h:"#process"},{l:"Rates",h:"#pricing"}].map(({l,h})=>(
                  <div key={l} style={{marginBottom:"11px"}}><a href={h} className="sans" style={{fontSize:"13px",color:tm,textDecoration:"none",transition:"color 0.2s ease",letterSpacing:"0.02em"}} onMouseEnter={e=>e.currentTarget.style.color=tp} onMouseLeave={e=>e.currentTarget.style.color=tm}>{l}</a></div>
                ))}
              ...
              <div>
                ...
                <div style={{marginBottom:"11px"}}><a href={COMMISSION_MAILTO} target="_blank" rel="noopener noreferrer" className="sans" style={{fontSize:"13px",color:tm,textDecoration:"none",transition:"color 0.2s ease",letterSpacing:"0.02em"}} onMouseEnter={e=>e.currentTarget.style.color=tp} onMouseLeave={e=>e.currentTarget.style.color=tm}>Book Session</a></div>
                <div style={{marginBottom:"11px"}}><a href={DIRECT_LINE_GMAIL} target="_blank" rel="noopener noreferrer" className="sans" style={{fontSize:"13px",color:tm,textDecoration:"none",transition:"color 0.2s ease",letterSpacing:"0.02em"}} onMouseEnter={e=>e.currentTarget.style.color=tp} onMouseLeave={e=>e.currentTarget.style.color=tm}>Direct Line</a></div>
            ...
            <div>
              ...
              <div style={{display:"flex",flexDirection:"column",gap:"14px"}}>
                {[{icon:<IgIcon/>,label:"Instagram",href:"https://www.instagram.com/hqauravocalstudios?igsh=MXhmZ3hqZTkzN2VueQ=="},{icon:<TwIcon/>,label:"Twitter / X",href:"https://x.com/hqauravocals"},{icon:<LiIcon/>,label:"LinkedIn",href:"https://www.linkedin.com/in/davidnwaibeavs/"}].map(item=>(
