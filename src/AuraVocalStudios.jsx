...
const DEMOS = [
  ...
  {
    id:12, size:"standard",
    title:"Just Sovereign",
    subtitle:"Athletic Legacy · Cultural Movement · Global Dominance",
    tag:"SPORT LUXURY", tone:"Bold · Unstoppable",
    accentSolid:"#f97316",
    src:"/demos/Track12.mp3",
    description:"This is not a sports ad. This is a movement given a voice. The read that carries the weight of an entire culture's ambition — raw, relentless, and built for the brands that don't just sell products, they define what it means to compete at the highest level on earth.",
  },
];
