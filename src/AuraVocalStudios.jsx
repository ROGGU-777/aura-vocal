...
const PROJECT_PATHS = [
  {
    ...
    subtitle:"Product launches · Advertising · Brand campaigns · TV & digital commercials",
    desc:"For brands where the campaign is the cultural moment. Luxury automotive, global FMCG, financial services, fashion — the commanding read that makes the audience stop, look, and believe.",
    features:["Network & digital broadcast ready","First-pass delivery standard","Global territory clearance","Brand tone consultation included"],
    accent:"#00F2FE",
    cta:"Commission a Commercial",
  },
  {
    id:"corporate",
    tag:"PATH B",
    title:"Corporate Narration",
    subtitle:"Training content · Explainer videos · Internal communications · Enterprise messaging",
    desc:"Enterprise organisations deploy Aura Vocal Studios when internal communications must carry the same authority as external campaigns. Clarity, credibility, and zero revision friction.",
    features:["E-learning & LMS formatted delivery","IVR and telephony suite production","Executive communication alignment","Sub-24H rush delivery available"],
    accent:"#a78bfa",
    cta:"Commission Corporate Narration",
  },
  {
    id:"creative",
    tag:"PATH C",
    title:"Premium Creative Projects",
    subtitle:"Gaming · Trailers · Cinematic storytelling · Entertainment projects",
    desc:"AAA studios, streaming platforms, and cinematic productions commission Aura Vocal Studios when the performance must outlast the project. Epic, intimate, ferocious — executed to perfection.",
    features:["Character range across 12 categories","Cinematic direction & emotional precision","ADR and remote session capability","Gaming, trailer & documentary formats"],
    accent:"#f43f5e",
    cta:"Commission a Creative Project",
  },
];
...
const PRICING_TIERS = [
  ...
  },
  {
    ...
    tag:"RECOMMENDED",
    from:"$12,000",
    desc:"Multi-deliverable campaign packages — brand campaigns with multiple executions, IVR suites, enterprise narration series, or gaming/cinematic projects requiring session depth.",
  ...
  },
  {
    ...
    tag:"ENTERPRISE",
    from:"Custom",
    desc:"Exclusive annual or project-based retainer for brands requiring a consistent voice partner across campaigns, product lines, or content series. Bespoke terms, dedicated availability.",
    includes:["Dedicated session allocation","Brand voice consultation","Priority scheduling","Direct communication channel","Custom delivery workflow","NDA and exclusivity available"],
    accent:"#f59e0b",
    highlight:false,
  },
];
      ...
      <div style={{position:"relative",zIndex:1}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"72px",alignItems:"center"}}>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:"14px"}}>
                {[
                  ...
                  {n:"$5K–8K",l:"Starting Engagement",accent:"#f59e0b",desc:"Premium positioning. Transparent entry point. Scoped to every project's exact requirements."},
                ].map((item,i)=>(
        ...
        <section style={{padding:"100px 28px 112px",maxWidth:"1280px",margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:"64px"}}>
            <div className="sans" style={{fontSize:"9px",letterSpacing:"0.32em",color:"#00F2FE",fontWeight:700,marginBottom:"16px"}}>WHERE DO YOU NEED TO GO?</div>
            <h2 className="serif" style={{fontSize:"clamp(28px,4vw,54px)",fontWeight:700,color:tp,lineHeight:1.08,letterSpacing:"-0.025em",marginBottom:"16px"}}>
              Choose Your<br/>
              <span style={{fontStyle:"italic",fontWeight:300,color:tm}}>Project Path</span>
            </h2>
            <p className="sans" style={{fontSize:"14px",color:tm,maxWidth:"520px",margin:"0 auto",lineHeight:1.78,fontWeight:300}}>Every campaign has a different demand. Select the pathway that matches your project — and commission a session built precisely around it.</p>
          </div>
          <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(300px,1fr))",gap:"20px",marginBottom:"48px"}}>
            {PROJECT_PATHS.map((path,i)=>(
              <div key={path.id} className="lift" style={{
                ...
                boxShadow:isDark?"0 8px 48px rgba(0,0,0,0.5)":"0 8px 32px rgba(0,0,0,0.08)",
                display:"flex",flexDirection:"column",gap:"0",
                transition:"border-color 0.4s ease, box-shadow 0.4s ease, transform 0.35s cubic-bezier(0.22,1,0.36,1)",
              }}
              onMouseEnter={e=>{e.currentTarget.style.borderColor=path.accent+"66";e.currentTarget.style.boxShadow=`0 24px 72px ${path.accent}18,0 8px 32px rgba(0,0,0,0.4)`;}}
              onMouseLeave={e=>{e.currentTarget.style.borderColor=isDark?"rgba(255,255,255,0.06)":"rgba(0,0,0,0.08)";e.currentTarget.style.boxShadow=isDark?"0 8px 48px rgba(0,0,0,0.5)":"0 8px 32px rgba(0,0,0,0.08)";}}>
                <div style={{position:"absolute",top:"-60px",right:"-60px",width:"240px",height:"240px",borderRadius:"50%",background:`radial-gradient(circle,${path.accent}12,transparent 70%)`,filter:"blur(40px)",pointerEvents:"none"}}/>
                <div style={{position:"absolute",bottom:"-40px",left:"-40px",width:"160px",height:"160px",borderRadius:"50%",background:`radial-gradient(circle,${path.accent}08,transparent 70%)`,filter:"blur(28px)",pointerEvents:"none"}}/>
                <div style={{marginBottom:"28px"}}>
                  <span className="sans" style={{fontSize:"8px",letterSpacing:"0.26em",fontWeight:700,color:path.accent,background:`${path.accent}18`,border:`1px solid ${path.accent}44`,padding:"4px 12px",borderRadius:"100px"}}>{path.tag}</span>
                </div>
                <h3 className="serif" style={{fontSize:"clamp(22px,2.4vw,30px)",fontWeight:700,color:tp,lineHeight:1.1,letterSpacing:"-0.02em",marginBottom:"10px"}}>{path.title}</h3>
                <p className="sans" style={{fontSize:"10.5px",color:path.accent,letterSpacing:"0.06em",fontWeight:600,marginBottom:"18px",textTransform:"uppercase"}}>{path.subtitle}</p>
                <p className="sans" style={{fontSize:"13px",lineHeight:1.82,color:isDark?tm:"#374151",fontWeight:300,marginBottom:"28px",flex:1}}>{path.desc}</p>
                <ul style={{listStyle:"none",padding:0,margin:"0 0 32px",display:"flex",flexDirection:"column",gap:"10px"}}>
                  {path.features.map((f,fi)=>(
                    <li key={fi} style={{display:"flex",alignItems:"flex-start",gap:"10px"}}>
                      <div style={{width:"16px",height:"16px",borderRadius:"50%",flexShrink:0,background:`${path.accent}18`,border:`1px solid ${path.accent}44`,display:"flex",alignItems:"center",justifyContent:"center",marginTop:"1px",color:path.accent}}><CheckIcon/></div>
                      <span className="sans" style={{fontSize:"12px",color:isDark?tm:"#374151",lineHeight:1.6,fontWeight:300}}>{f}</span>
                    </li>
                  ))}
                </ul>
                <a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" className="sans" style={{
                  display:"inline-flex",alignItems:"center",justifyContent:"center",gap:"8px",
                  padding:"13px 28px",borderRadius:"100px",
                  border:`1.5px solid ${path.accent}55`,
                  background:`${path.accent}0E`,
                  color:path.accent,fontSize:"12px",letterSpacing:"0.07em",fontWeight:700,
                  textDecoration:"none",
                  transition:"all 0.3s ease",
                }}
                onMouseEnter={e=>{e.currentTarget.style.background=path.accent;e.currentTarget.style.color="#000";e.currentTarget.style.borderColor=path.accent;e.currentTarget.style.boxShadow=`0 0 32px ${path.accent}55`;}}
                onMouseLeave={e=>{e.currentTarget.style.background=`${path.accent}0E`;e.currentTarget.style.color=path.accent;e.currentTarget.style.borderColor=`${path.accent}55`;e.currentTarget.style.boxShadow="none";}}>{path.cta} <LinkIcon/></a>
              </div>
            ))}
          </div>
          <div style={{textAlign:"center",padding:"44px",borderRadius:"20px",background:isDark?"rgba(0,242,254,0.03)":"rgba(0,242,254,0.04)",border:`1px solid ${isDark?"rgba(0,242,254,0.1)":"rgba(0,242,254,0.18)"}`,backdropFilter:"blur(20px)"}}>
            <p className="sans" style={{fontSize:"12px",color:tm,letterSpacing:"0.04em",marginBottom:"18px",fontWeight:300}}>Not sure which path fits your project?</p>
            <a href={MAILTO_LINK} className="sans" style={{display:"inline-flex",alignItems:"center",gap:"8px",padding:"12px 32px",borderRadius:"100px",background:"transparent",border:`1px solid ${border}`,color:tm,fontSize:"12px",letterSpacing:"0.06em",fontWeight:600,textDecoration:"none",transition:"all 0.3s ease"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#00F2FE55";e.currentTarget.style.color=tp;}} onMouseLeave={e=>{e.currentTarget.style.borderColor=border;e.currentTarget.style.color=tm;}}><MailIcon/> Send a Brief — We Will Guide You</a>
          </div>
        </section>
        ...
        <section style={{padding:"100px 28px 112px",maxWidth:"1280px",margin:"0 auto"}}>
          <div style={{textAlign:"center",marginBottom:"64px"}}>
            <div className="sans" style={{fontSize:"9px",letterSpacing:"0.32em",color:"#00F2FE",fontWeight:700,marginBottom:"16px"}}>INVESTMENT</div>
            <h2 className="serif" style={{fontSize:"clamp(28px,4vw,54px)",fontWeight:700,color:tp,lineHeight:1.08,letterSpacing:"-0.025em",marginBottom:"16px"}}>
              Projects Begin at<br/>
              <span style={{fontStyle:"italic",fontWeight:300,color:tm}}>$5,000 – $8,000</span>
            </h2>
            <p className="sans" style={{fontSize:"14px",color:tm,maxWidth:"520px",margin:"0 auto",lineHeight:1.78,fontWeight:300}}>Aura Vocal Studios operates at the premium tier of voice performance. Every engagement is scoped to the project — not templated. The following structures are starting frameworks.</p>
          </div>
          <div className="pricing-grid" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:"20px",marginBottom:"48px"}}>
            {PRICING_TIERS.map((tier,i)=>(
              <div key={i} style={{
                position:"relative",overflow:"hidden",
                borderRadius:"24px",
                padding: tier.highlight ? "2px" : "0",
                background: tier.highlight ? `linear-gradient(135deg,${tier.accent}88,${tier.accent}22)` : "transparent",
              }}>
                <div style={{
                  borderRadius: tier.highlight ? "22px" : "24px",
                  padding:"40px 32px",height:"100%",
                  background:isDark?"rgba(5,5,5,0.95)":"rgba(255,255,255,0.97)",
                  border: tier.highlight ? "none" : `1px solid ${isDark?"rgba(255,255,255,0.06)":"rgba(0,0,0,0.08)"}`,
                  backdropFilter:"blur(24px)",
                  boxShadow: tier.highlight ? `0 24px 64px ${tier.accent}18` : isDark?"0 8px 40px rgba(0,0,0,0.45)":"0 6px 28px rgba(0,0,0,0.07)",
                  display:"flex",flexDirection:"column",
                }}>
                  {tier.highlight&&<div style={{position:"absolute",top:0,left:0,right:0,height:"1px",background:`linear-gradient(90deg,transparent,${tier.accent},transparent)`,opacity:0.6}}/>}
                  <div style={{position:"absolute",top:"-40px",right:"-40px",width:"160px",height:"160px",borderRadius:"50%",background:`radial-gradient(circle,${tier.accent}0A,transparent 70%)`,filter:"blur(28px)",pointerEvents:"none"}}/>
                  <div style={{marginBottom:"24px"}}>
                    <span className="sans" style={{fontSize:"8px",letterSpacing:"0.26em",fontWeight:700,color:tier.accent,background:`${tier.accent}18`,border:`1px solid ${tier.accent}44`,padding:"4px 12px",borderRadius:"100px"}}>{tier.tag}</span>
                  </div>
                  <div className="serif" style={{fontSize:"15px",fontWeight:700,color:tp,letterSpacing:"0.04em",marginBottom:"8px"}}>{tier.tier}</div>
                  <div style={{marginBottom:"20px"}}>
                    <span className="serif" style={{fontSize:"clamp(32px,3vw,44px)",fontWeight:700,color:tier.accent,letterSpacing:"-0.03em",lineHeight:1}}>{tier.from}</span>
                    {tier.from !== "Custom" && <span className="sans" style={{fontSize:"11px",color:ts,marginLeft:"8px",fontWeight:300}}>starting engagement</span>}
                  </div>
                  <p className="sans" style={{fontSize:"12.5px",lineHeight:1.78,color:isDark?tm:"#374151",fontWeight:300,marginBottom:"28px",flex:1}}>{tier.desc}</p>
                  <ul style={{listStyle:"none",padding:0,margin:"0 0 32px",display:"flex",flexDirection:"column",gap:"10px"}}>
                    {tier.includes.map((item,ii)=>(
                      <li key={ii} style={{display:"flex",alignItems:"flex-start",gap:"10px"}}>
                        <div style={{width:"16px",height:"16px",borderRadius:"50%",flexShrink:0,background:`${tier.accent}18`,border:`1px solid ${tier.accent}44`,display:"flex",alignItems:"center",justifyContent:"center",marginTop:"1px",color:tier.accent}}><CheckIcon/></div>
                        <span className="sans" style={{fontSize:"12px",color:isDark?tm:"#374151",lineHeight:1.6,fontWeight:300}}>{item}</span>
                      </li>
                    ))}
                  </ul>
                  <a href={tier.from==="Custom"?MAILTO_LINK:BOOKING_LINK} target="_blank" rel="noopener noreferrer" className={tier.highlight?"sans shimmer-btn":"sans"} style={{
                    display:"inline-flex",alignItems:"center",justifyContent:"center",gap:"8px",
                    padding:"14px 28px",borderRadius:"100px",
                    border: tier.highlight ? "none" : `1.5px solid ${tier.accent}55`,
                    background: tier.highlight ? undefined : `${tier.accent}0E`,
                    color: tier.highlight ? "#000" : tier.accent,
                    fontSize:"12px",letterSpacing:"0.07em",fontWeight:700,
                    textDecoration:"none",
                    transition:"all 0.3s ease",
                    boxShadow: tier.highlight ? "0 0 28px rgba(167,139,250,0.35)" : "none",
                  }}
                  onMouseEnter={e=>{if(!tier.highlight){e.currentTarget.style.background=tier.accent;e.currentTarget.style.color="#000";e.currentTarget.style.borderColor=tier.accent;e.currentTarget.style.boxShadow=`0 0 28px ${tier.accent}55`;}}}
                  onMouseLeave={e=>{if(!tier.highlight){e.currentTarget.style.background=`${tier.accent}0E`;e.currentTarget.style.color=tier.accent;e.currentTarget.style.borderColor=`${tier.accent}55`;e.currentTarget.style.boxShadow="none";}}}>
                    {tier.from==="Custom"?"Discuss Retainer":"Commission a Session"} <LinkIcon/>
                  </a>
                </div>
              </div>
            ))}
          </div>
          <div style={{padding:"32px 40px",borderRadius:"18px",background:isDark?"rgba(255,255,255,0.022)":"rgba(255,255,255,0.82)",border:`1px solid ${border}`,backdropFilter:"blur(16px)",display:"flex",alignItems:"center",justifyContent:"space-between",gap:"24px",flexWrap:"wrap"}}>
            <div>
              <div className="sans" style={{fontSize:"12px",fontWeight:600,color:tp,marginBottom:"4px",letterSpacing:"0.02em"}}>Not sure what your project requires?</div>
              <div className="sans" style={{fontSize:"12px",color:tm,fontWeight:300}}>Send the brief. David will scope it personally and respond within the business day.</div>
            </div>
            <a href={MAILTO_LINK} className="sans" style={{display:"inline-flex",alignItems:"center",gap:"8px",padding:"12px 28px",borderRadius:"100px",border:`1px solid ${border}`,background:"transparent",color:tm,fontSize:"12px",letterSpacing:"0.06em",fontWeight:600,textDecoration:"none",transition:"all 0.3s ease",whiteSpace:"nowrap"}} onMouseEnter={e=>{e.currentTarget.style.borderColor="#00F2FE55";e.currentTarget.style.color=tp;}} onMouseLeave={e=>{e.currentTarget.style.borderColor=border;e.currentTarget.style.color=tm;}}><MailIcon/> Send the Brief</a>
          </div>
        </section>
          ...
          <div style={{
            ...
            <div style={{position:"relative",zIndex:1}}>
              ...
              <div style={{marginTop:"44px",paddingTop:"36px",borderTop:`1px solid ${isDark?"rgba(255,255,255,0.06)":"rgba(0,0,0,0.07)"}`,display:"flex",justifyContent:"center",gap:"52px",flexWrap:"wrap"}}>
                {[["Starting engagement","$5K–$8K"],["Projects delivered","80+"],["Turnaround","<48 hours"],["Experience","5+ Years"]].map(([l,n])=>(
          ...
          <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start",flexWrap:"wrap",gap:"40px",marginBottom:"48px"}}>
            ...
            <div style={{display:"flex",gap:"60px"}}>
              ...
              <div>
                ...
                <div style={{marginBottom:"11px"}}><a href={BOOKING_LINK} target="_blank" rel="noopener noreferrer" className="sans" style={{fontSize:"13px",color:tm,textDecoration:"none",transition:"color 0.2s ease",letterSpacing:"0.02em"}} onMouseEnter={e=>e.currentTarget.style.color=tp} onMouseLeave={e=>e.currentTarget.style.color=tm}>Book Session</a></div>
