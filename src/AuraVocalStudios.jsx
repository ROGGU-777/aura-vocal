...
const BOOKING_LINK = "https://tally.so/r/pbzoZb";
const MAILTO_LINK = "mailto:concierge@studiohqauravocal.site?subject=Project%20Inquiry%20%E2%80%94%20Aura%20Vocal%20Studios&body=Hello%20David%2C%0A%0AProject%3A%20%5BBrand%2FProject%20Name%5D%0AOverview%3A%20%5BDescribe%20briefly%5D%0ACategory%3A%20%5BCommercial%20%2F%20Documentary%20%2F%20Enterprise%20%2F%20Other%5D%0ADeadline%3A%20%5BDate%5D%0ABudget%3A%20%5BRange%5D%0A%0AKind%20regards%2C%0A%5BYour%20Name%5D%0A%5BCompany%5D";
        ...
        <section style={{padding:"80px 28px",borderTop:`1px solid ${border}`,borderBottom:`1px solid ${border}`,background:isDark?"rgba(255,255,255,0.012)":"rgba(0,0,0,0.012)"}}>
          <div style={{maxWidth:"1280px",margin:"0 auto"}}>
            ...
            <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(250px,1fr))",gap:"18px"}}>
              {WHY.map((w,i)=>(
                <div key={i} className="lift glass-card" style={{padding:"28px 26px",borderRadius:"18px",background:glass,border:`1px solid ${border}`,boxShadow:isDark?"0 8px 32px rgba(0,0,0,0.4)":"0 4px 20px rgba(0,0,0,0.06)"}}>
                  <div style={{display:"flex",alignItems:"center",gap:"10px",marginBottom:"11px"}}>
                    <div style={{width:"22px",height:"22px",borderRadius:"50%",flexShrink:0,background:"rgba(0,242,254,0.15)",border:"1px solid rgba(0,242,254,0.4)",display:"flex",alignItems:"center",justifyContent:"center",color:"#00F2FE"}}><CheckIcon/></div>
          ...
          <div onClick={()=>setShowAbout(false)} style={{position:"fixed",inset:0,zIndex:500,background:"rgba(0,0,0,0.82)",backdropFilter:"blur(14px)",WebkitBackdropFilter:"blur(14px)",display:"flex",alignItems:"center",justifyContent:"center",padding:"24px"}}>
            <div onClick={e=>e.stopPropagation()} style={{maxWidth:"680px",width:"100%",borderRadius:"24px",padding:"48px",background:isDark?"linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.01))":"rgba(255,255,255,0.97)",border:`1px solid ${isDark?"rgba(0,242,254,0.14)":"rgba(0,0,0,0.08)"}`,backdropFilter:"blur(32px)",boxShadow:isDark?"0 32px 80px rgba(0,0,0,0.7)":"0 24px 64px rgba(0,0,0,0.12)",position:"relative"}}>
              ...
              <div style={{display:"flex",gap:"28px",paddingTop:"24px",borderTop:`1px solid ${isDark?"rgba(255,255,255,0.07)":"rgba(0,0,0,0.08)"}`,flexWrap:"wrap",marginBottom:"28px"}}>
                {[["12","Performance Categories"],["<48H","Delivery Standard"],["Zero","Revision Rate"],["Global","Clearance"]].map(([n,l])=>(
                  <div key={l}>
