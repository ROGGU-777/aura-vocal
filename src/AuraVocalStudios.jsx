  ...
  return (
    ...
    >
      ...
      <div style={{marginTop:"8px",fontSize:"10px",color:isDark?"#64748b":"#94a3b8",fontFamily:"'DM Sans',sans-serif"}}>
        ...
        {/* Time stamps */}
        <div style={{display:"flex",justifyContent:"space-between",marginTop:"4px",userSelect:"none"}}>
...
export default function AuraVocalStudios() {
  ...
  return (
    <div style={{ background: bg, color: textPrimary, minHeight: "100vh", fontFamily: "'Cormorant Garamond', Georgia, serif" }}>
      ...
      {/* ── BACKGROUND ORBS ──────────────────────────────────────────── */}
      <div style={{position:"fixed",inset:0,pointerEvents:"none",overflow:"hidden",zIndex:0}} style={{ zIndex: 0 }}>
        <div style={{
